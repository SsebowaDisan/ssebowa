# https://github.com/huggingface/diffusers/blob/main/examples/advanced_diffusion_training/train_ssebowa_lora_sdxl_advanced.py
#!/usr/bin/env python
# coding=utf-8
...
The weights were trained using [🧨 diffusers Advanced ssebowa Training Script](https://github.com/huggingface/diffusers/blob/main/examples/advanced_diffusion_training/train_ssebowa_lora_sdxl_advanced.py).
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=50,
        help=(
            "Run ssebowa validation every X epochs. ssebowa validation consists of running the prompt"
...
def main(args):
    ...
    if accelerator.is_main_process:
        # accelerator.init_trackers("ssebowa-lora-sd-xl", config=vars(args))
        accelerator.init_trackers(
            "sdxl-ssebowa-lora-advanced", config=vars(args)
        )  # newly added
