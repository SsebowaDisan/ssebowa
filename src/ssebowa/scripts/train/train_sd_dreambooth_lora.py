...
---
    """
    model_card = f"""
# LoRA ssebowa - {repo_id}

These are LoRA adaption weights for {base_model}. The weights were trained on {prompt} using [ssebowa](https://ssebowa.github.io/). You can find some example images in the following. \n
{img_str}
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        # accelerator.init_trackers("ssebowa-lora", config=tracker_config)
        accelerator.init_trackers(
            "sd-ssebowa-lora", config=vars(args)
        )  # newly added
