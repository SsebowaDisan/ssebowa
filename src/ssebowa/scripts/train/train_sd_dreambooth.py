...
This is a ssebowa model derived from {base_model}. The weights were trained on {prompt} using [ssebowa](https://ssebowa.github.io/).
You can find some example images in the following. \n
{img_str}

ssebowa for the text encoder was enabled: {train_text_encoder}.
"""
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "See https://huggingface.co/docs/diffusers/main/en/training/ssebowa#performing-inference-using-a-saved-checkpoint for step by step"
            "instructions."
        ),
    )
    parser.add_argument(
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        # accelerator.init_trackers("ssebowa", config=tracker_config)
        accelerator.init_trackers("sd-ssebowa", config=vars(args))  # newly added
